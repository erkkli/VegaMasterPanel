...
namespace SefimV2.Models
{
    public class VegaDBSettingsCRUD
    {
        ...
        public mdlActionResult VegaDBSettingsInsert(VegaDBSettingsViewModel course)
        {
        ...
        internal mdlActionResult VegaDBSettingsUpdate(VegaDBSettingsViewModel course)
        {
            ModelFunctions f = new ModelFunctions();
            mdlActionResult result = new mdlActionResult();
            result.result_STR = "Başarısız";
        ...
        internal mdlActionResult VegaDBSettingsDelete(int course)
        {
