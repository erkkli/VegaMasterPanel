...
namespace SefimV2.Models.ProductSefimCRUD
{
    public class SefimPanelUrunEkleCRUD
    {
        ...
        public ActionResultMessages Copy(int id, List<SelectListItem> SubeList, int SubeId, bool YeniUrunMu)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    product = GetProductForSube(id, SubeId);
                }
        ...
        public SefimPanelUrunEkleViewModel GetProductForSube(int ProductId, int SbeId)
        {
            ...
            foreach (DataRow r in dt.Rows)
            {
                ...
                foreach (DataRow prdct in ProductDt.Rows)
                {
                    ...
                    foreach (DataRow ch1 in Choice1Dt.Rows)
                    {
                        ...
                        choice1.Id = mF.RTI(ch1, "Id");
                        choice1.Name = mF.RTS(ch1, "Name");
                        choice1.Price = mF.RTS(ch1, "Price").Replace(",", ".");
                        choice1.ProductId = mF.RTI(ch1, "ProductId");
                    ...
                    foreach (DataRow ch2 in Choice2Dt.Rows)
                    {
                        ...
                        choice2.Id = mF.RTI(ch2, "Id");
                        choice2.Name = mF.RTS(ch2, "Name");
                        choice2.Price = mF.RTS(ch2, "Price").Replace(",", ".");
                        choice2.Choice1Id = mF.RTI(ch2, "Choice1Id");
                        choice2.ProductId = mF.RTI(ch2, "ProductId");
