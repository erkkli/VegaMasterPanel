...
namespace SefimV2.Models
{
    ...
    {
        public static List<SubeUrun> List(DateTime Date1, DateTime Date2, string subeid, string ID, string payReportID)
        {
                                    ...
                                    if (subeid.Equals(""))
                                    {
                                        if (AppDbType == "3")
                                        {
                                            ...
                                            foreach (DataRow sube in SubeUrunCiroDt.Rows)
                                            {
                                                ...
                                                items.ProductName = sube["ProductName"].ToString();  //f.RTS(SubeR, "ProductName");
                                                Liste.Add(items);
                                            }
