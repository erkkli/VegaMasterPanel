...
namespace SefimV2.Helper
{
    public static class HtmlHelperExtensions
    {
        public static void RemoveFor<TModel>(this ModelStateDictionary modelState, Expression<Func<TModel, object>> expression)
        {
            ...
            {
                if (ms.Key == fieldName || ms.Key.Contains("." + fieldName))
                {
        ...
        /// <summary>
        ///     Enumu alfabetik olarak sıralı set eder.
        /// </summary>        
        /// <returns></returns>
        public static MvcHtmlString EnumSortedDropDownListFor<TModel, TEnum>(this HtmlHelper<TModel> htmlHelper,
            ...
            )
        {
            ...
            var selectList = EnumHelper.GetSelectList(metadata.ModelType).Where(x => x.Text != "Seçiniz").OrderBy(i => i.Text).ToList();
