								...
								if (typeof column.selector !== 'undefined' &&
									...
									var chk = $('<label/>').
										...
										append($('<input/>').
											attr('type', 'checkbox').
                                            attr('value', value).
                                            attr('id', 'checkVal_' + value).
                                            attr('data-field', c_field).
											on('click', function() {
												if ($(this).is(':checked')) {
				...
				pagination: {
					items: {
						default: {
							...
							last: 'Son',
							more: 'Daha Fazla',
							input: 'Sayfa Numarasi',
							select: 'Kayit Sayisi',
						},
						info: 'Gosterilen {{start}} - {{end}}  kayit toplam {{total}}',
					},
				},
			},
		},
