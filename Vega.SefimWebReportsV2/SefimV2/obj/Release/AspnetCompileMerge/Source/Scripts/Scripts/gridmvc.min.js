    ...
    */
    gridMvc.prototype.openFilterPopup = function (self, html) {
        ...
        if (this.hasAttribute("data-rendered")) {
            ...
            if (typeof (widget.setHeight) != 'undefined') {
                widget.setHeight($(this),difHeight);
            }
            return or;
        }
...
TextFilterWidget = (function ($) {
    ...
    */
    ...
    textFilterWidget.prototype.setHeight = function (grid,height) {
        var scrollHeight = grid.closest('.grid-wrap').prop('scrollHeight');
        grid.closest('.grid-wrap').height(scrollHeight + height);
    };
    /***
...
NumberFilterWidget = (function ($) {
    ...
    numberFilterWidget.prototype.setHeight = function (grid, height) {
        var scrollHeight = grid.closest('.grid-wrap').prop('scrollHeight');
        grid.closest('.grid-wrap').height(scrollHeight + height);
    };
...
DateTimeFilterWidget = (function ($) {
    ...
    dateTimeFilterWidget.prototype.setHeight = function (grid, height) {
        var scrollHeight = grid.closest('.grid-wrap').prop('scrollHeight');
        grid.closest('.grid-wrap').height(scrollHeight + height);
    };
...
BooleanFilterWidget = (function ($) {
    ...
    booleanFilterWidget.prototype.setHeight = function (grid, height) {
        var scrollHeight = grid.closest('.grid-wrap').prop('scrollHeight');
        grid.closest('.grid-wrap').height(scrollHeight + height);
    };
...
EnumFilterWidget = (function ($) {
    ...
    enumFilterWidget.prototype.setHeight = function (grid, height) {
        var scrollHeight = grid.closest('.grid-wrap').prop('scrollHeight');
        grid.closest('.grid-wrap').height(scrollHeight + height);
    };
