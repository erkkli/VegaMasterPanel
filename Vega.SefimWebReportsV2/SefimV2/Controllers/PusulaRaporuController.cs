...
{
    [CheckLoggedIn]
    public class PusulaRaporuController : Controller
    {
        // GET: UrunGrubu
        ...
        public ActionResult List()
        {
            ...
            ViewBag.Pages = "Adisyon";
            ViewBag.PageNavi = "Adisyon Raporu";
            #endregion Secilen Tarih Filterelemesine Göre Yapılan İşlemler  


            List<PusulaRaporuViewModel> list = PusulaRaporuCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), subeid, productgrup, ID);
            return View(list);
        }
        #endregion LIST
        ...
        public ActionResult AdisyonDetails()
        {
            string ID = Request.Cookies["PRAUT"].Value;
            #region Secilen Tarih Filterelemesine Göre Yapılan İşlemler  
            string tarihAraligiStartDate = "";
            ...
            //List<UrunGrubu> list = UrunGrubuCRUD.List(GelenGun, GelenGunSonu, subeid, productgrup);
            List<PusulaRaporuViewModel> list = PusulaRaporuCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), subeid, productgrup.Replace("_", " "), ID);
            //List<UrunGrubu> CiroyaGoreListe = list.OrderByDescending(o => o.ProductGroup). ToList();
