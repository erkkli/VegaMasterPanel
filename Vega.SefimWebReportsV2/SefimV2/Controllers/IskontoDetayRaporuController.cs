...
{
    [CheckLoggedIn]
    public class IskontoDetayRaporuController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            ViewBag.Pages = "İskonto Detay Raporu";
            ViewBag.PageNavi = "İskonto Detay Raporu";
            #endregion Secilen Tarih Filterelemesine Göre Yapılan İşlemler  


            List<IskontoDetayRaporuViewModel> list = IskontoDetayRaporuCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), "", "", ID);
            return View(list);
        }
        #endregion LIST
        ...
        public ActionResult Details()
        {
            ...
            List<IskontoDetayRaporuViewModel> list = IskontoDetayRaporuCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), subeid, productgrup, ID);
