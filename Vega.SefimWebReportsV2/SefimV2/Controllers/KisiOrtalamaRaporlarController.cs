...
{
    [CheckLoggedIn]
    public class KisiOrtalamaRaporlarController : Controller
    {
        // GET: KisiOrtalamaRaporlar
        ...
        public ActionResult List()
        {
            ...
            ViewBag.Pages = "Kisi Sayisi Ortalama";
            ViewBag.PageNavi = "Kişi Sayısı Raporu";
            #endregion

           var list = KisiOrtalamaRaporlarCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), ID);
            return View(list);
        }
        #endregion LIST
        ...
        public JsonResult SendReportMail(string StartDate, string EndDate, string ePostaAdress, string Pages)
        {
            ...
            List<KisiOrtalamaReportSendMailViewModel> list_ = SendMailKisiOrtalamaCRUD.List(Convert.ToDateTime(StartDate), Convert.ToDateTime(EndDate), ID);
