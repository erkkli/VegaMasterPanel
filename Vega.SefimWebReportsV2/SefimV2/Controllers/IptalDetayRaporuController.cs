...
{
    [CheckLoggedIn]
    public class IptalDetayRaporuController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            {
                Singleton.WritingLogFile("IptalDetayRaporuController", ex.Message.ToString());
            }
            ...
            ViewBag.Pages = "İptal Detay Raporu";
            ViewBag.PageNavi = "İptal Detay Raporu";
            #endregion Secilen Tarih Filterelemesine Göre Yapılan İşlemler  


            List<IptalDetayRaporuViewModel> list = IptalDetayRaporuCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), "", "", ID);
            return View(list);
        }
        #endregion LIST
        ...
        public ActionResult Details()
        {
            ...
            List<IptalDetayRaporuViewModel> list = IptalDetayRaporuCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), subeid, productgrup, ID);
