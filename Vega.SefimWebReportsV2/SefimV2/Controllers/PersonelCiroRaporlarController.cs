...
{
    [CheckLoggedIn]
    public class PersonelCiroRaporlarController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            ViewBag.Pages = "Kasiyer Tahsilat Raporu";
            ViewBag.PageNavi = "Kasiyer Tahsilat Raporu";
            #endregion

            List<PersonelCiro> list = PersonelCiroCRUD.List(Convert.ToDateTime(viewModel.StartDate), Convert.ToDateTime(viewModel.EndDate), subeid, ID);
            return View(list);
        }
        #endregion LIST
        ...
        public ActionResult Details()
        {
            ...
            ViewBag.StartDateTime = viewModel.StartDate;
            ViewBag.EndDateTime = viewModel.EndDate;
            ViewBag.Pages = "Personel Ciro Detay";
