...
SELECT
@Sube as Sube,
(SELECT TOP 1 SUBEADI FROM TBLFASTERKASALAR WHERE SUBENO=TBLFASTERSATISBASLIK.SUBEIND) AS Sube1,
(SELECT KASAADI FROM TBLFASTERKASALAR WHERE KASANO=TBLFASTERSATISBASLIK.KASAIND) AS Kasa,
